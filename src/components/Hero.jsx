      ...
      <div className="container mx-auto px-4 py-20 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl mb-8 text-white/90 max-w-3xl mx-auto leading-relaxed">
            Atualmente estudando <strong>Python</strong>, 
            <strong> automação com Selenium</strong>, 
            <strong> APIs</strong> e 
            <strong> Inteligência Artificial aplicada</strong>, 
            desenvolvendo projetos práticos para evoluir constantemente na área de tecnologia.
          </p>
